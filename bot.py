...
# ─── CONFIG ───────────────────────────────────────────────────────
BOT_TOKEN = "8339740358:AAF_XVSEQ8o6GqqiOCQo7MvwJDjMuGX39KU"
...
# ─── GITHUB SYNC SETUP ────────────────────────────────────────────
# v2: এখন BASE_DIR পুরোটা recursively watch হয় (watchdog দিয়ে) —
# মানে projects/<pid>/ এর ভিতরে child bot subprocess নিজে যেকোনো
# ফাইল/ডাটা লিখলে/বদলালে/মুছলে, সেটাও automatic GitHub-এ sync হবে।
import github_sync

GITHUB_PAT = os.environ.get("GITHUB_PAT", "")  # Railway Variables থেকে নেওয়া হবে

if not GITHUB_PAT:
    print("⚠️ WARNING: GITHUB_PAT env var খালি/সেট করা নেই — GitHub sync কাজ করবে না!")
else:
    print(f"✅ GITHUB_PAT লোড হয়েছে ({len(GITHUB_PAT)} chars)")
