...
# GitHub sync ফিচারটা বন্ধ করা হয়েছে (VPS-এ আলাদা ব্যাকআপ থাকায় আর দরকার নেই)।
# নিচের no-op stub-টা আসল github_sync মডিউলের জায়গা নিচ্ছে, যাতে কোডের
# বাকি অংশে থাকা sync_file/sync_dir/sync_delete কলগুলো ভাঙে না —
# শুধু কিছুই করবে না।
class _NoOpGithubSync:
    def setup(self, *args, **kwargs):
        pass
    def sync_file(self, *args, **kwargs):
        pass
    def sync_dir(self, *args, **kwargs):
        pass
    def sync_delete(self, *args, **kwargs):
        pass

github_sync = _NoOpGithubSync()
# ──────────────────────────────────────────────────────────────────
